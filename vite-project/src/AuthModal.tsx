                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
                        ...
                        >
                            ...
                            <div className="p-8">
                                ...
                                <button
                                    onClick={handleSubmit} // Using the same simulated success for GitHub
                                    className="flex items-center justify-center w-full gap-3 py-3 text-sm font-medium text-white transition-all bg-[#21262d] border border-[#30363d] rounded-lg hover:bg-[#30363d]"
                                >
