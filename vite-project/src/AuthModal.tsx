                        ...
                        {verificationSent ? (
                            ...
                            <>
                                ...
                                <div className="w-full mt-4 space-y-2">
                                    ...
                                    <button type="button" onClick={() => handleOAuthLogin('github')} disabled={isAuthenticating} className="w-full py-2.5 bg-transparent border border-[#27272a] rounded-md text-sm text-zinc-300 font-medium hover:bg-[#1a1a1a] transition-colors flex items-center justify-center gap-2 disabled:opacity-50">
