                        ...
                        <AnimatePresence>
                            {displayedScholarships.map((scholarship) => (
                                <motion.div
                                    ...
                                    className="bg-[#0a0a0a] border border-[#1a1a1a] shadow-none   hover:border-emerald-500/40 rounded-2xl p-6 relative overflow-hidden group shadow-xl flex flex-col h-full"
                                >
